...
def output_table(title: str, data: list) -> int:
    ...
    for info in data:
        table.add_row(info.get("imageTags"), info.get("imagePushedAt"), info.get("appliedRulePriority"))
...
try:
    ...
    for result in results:
        ...
        data.append({"imageTags": imageTags, "imagePushedAt": imagePushedAt, "appliedRulePriority": str(appliedRulePriority)})
