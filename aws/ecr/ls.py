            ...
            if len(all_repos) != 0:
                ...
                for repo_name in all_repos:
                    ...
                    for image in all_images:
                        ...
                        if len(imageTags) != 0:
                            _image_data.append({"imageTags": imageTags, "lastRecordedPullTime": lastRecordedPullTime})
                        else:
                            _image_data.append({"imageDigest": imageDigest, "lastRecordedPullTime": lastRecordedPullTime})

                    # image_data = {"images": _image_data}

                    _repo_data.append({"repositoryName": repo_name, "images": _image_data})
